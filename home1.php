    ...
    <style>
        ...
        * {
        ...
        .centered-container {
            ...
            /* Adjust position based on its own width/height */
...
<body>
    ...
    // Input data to be sent to the API
    $input_data = [
        [
            "Parameter" => $parameter,
    ...
    <div class="d-flex justify-content-between mt-1 pt-3">
        ...
        <div class="mx-2 mt-1" style="margin-top: -5px;">
            <?php if ($verified_mobile): ?>
                <a href="logout.php" id="logout" class="btn btn-danger rounded-circle"
                    style="width: 30px; height: 30px; display: flex; align-items: center; justify-content: center;">
    ...
    <div class="container col-12 col-md-8 col-lg-5">
        <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                ...
                <div class="carousel-item">
                    <img src="Xpress.png" class="d-block w-100" alt="picture4">
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="container mt-3">
                <div class="dropdown">
                    <b><label for="itemGroupSelect" class="form-label" style="font-size: 14px;">Select Item Group:</label></b>
                    <select id="itemGroupSelect" class="form-select" name="item_group"
                        ...
                        foreach ($data['result'] as $item) {
                            ...
                            // Set the URL with the selected ItemGroupId pointing to home.php
            ...
            <!-- for subcategory visible and click......created by Digvijay Vapilkar -->
            ...
            <!-- Subcategory menu with counts and active highlight -->
            ...
            <!-- this is for subcategory items container data created by Digvijay Vapilkar -->
                ...
                <div class="row">
                    <?php foreach ($filteredItems as $item): ?>
                        ...
                        if ($item['MenuTypeId'] == '0' || $item['MenuTypeId'] == '1') {
                            $menuTypeIcon = 'veg_icon.png';
                        } elseif ($item['MenuTypeId'] == '2') {
                            $menuTypeIcon = 'nonvegicon.png';
                        }
                        ?>
                        <div class="col-md-12">
            ...
            <!-- this is for main entire items data -->
