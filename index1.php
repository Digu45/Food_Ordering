    ...
    <script>
       $(document).ready(function() {
        $('#sendOtpButton').click(function() {
            ...
            // Proceed with AJAX request if the validation passes
            $.ajax({
                url: 'index.php',
                type: 'POST',
                            ...
                            <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
                                <form id="otpForm" method="POST" action="" onsubmit="return validateForm()">
                                    <div class="form-outline mb-4" id="phoneSection">
                                        <input type="tel" id="phoneNumber" class="form-control form-control-lg" name="mob_no" placeholder="Enter your phone number" maxlength="10" required />
                                    ...
                                    <div class="form-outline mb-4" id="otpSection" style="display:none;">
                                        <input type="tel" id="otp" class="form-control form-control-lg" name="otp" placeholder="Enter OTP" />
